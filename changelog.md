...
Examples on how to use Preflight are available in the [ReadMe](https://github.com/DevinPatel72/Static-Analysis-Results-Parser/blob/main/readme.md#configure-preflight).
