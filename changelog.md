...
The old `user_overrides.json` template is ported to a default profile that is toggle-able. Also, a significant number of rules have been added or amended.

Documentation on how **Preflight** works is available [here](#TODO).
