...
| `-f`<br>`--file FILE`                                                              | Load a user inputs JSON configuration file. Accepts either an absolute path or a filename located in the `config/inputs` directory. Defaults to `config/inputs/sarp_inputs.json` if no input options are specified. |
...
| `--disable-progressbar`                                                            | Disables progress bar in CLI for faster performance.                                                                                                                                                                              |
